    ...
    <section id="about">
      <div className="container mx-auto">
        <div className="flex flex-wrap">
          <div className="self-center w-full px-4 lg:w-[60%]">
            <div className="relative mb-2 lg:mb-5">
              <img src={shape} width={100} className="absolute -z-10 top-2 lg:w-48 " />
              <h1 className="font-bold text-left text-2xl lg:text-5xl text-[#357998]">
                🧑‍💻 About Me
              </h1>
            </div>
            <p className="text-sm text-left lg:text-xl text-secondary">
